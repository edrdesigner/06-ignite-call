...
INSERT INTO "new_user_time_intervals" ("id", "time_start_in_minutes", "time_end_in_minutes", "user_id", "week_day") SELECT "id", "time_start_in_minutes", "time_end_ind_minutes", "user_id", "week_day" FROM "user_time_intervals";
